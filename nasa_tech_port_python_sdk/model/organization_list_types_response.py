...
class OrganizationListTypesResponse(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class organizations(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['OrganizationType']:
                        return OrganizationType
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['OrganizationType'], typing.List['OrganizationType']],
                ...
                def __getitem__(self, i: int) -> 'OrganizationType':
